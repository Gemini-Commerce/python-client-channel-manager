...
class TestChannelmanagerChannelResponseWithAssociations(unittest.TestCase):
    """ChannelmanagerChannelResponseWithAssociations unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChannelmanagerChannelResponseWithAssociations:
        """Test ChannelmanagerChannelResponseWithAssociations
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChannelmanagerChannelResponseWithAssociations`
        """
        model = ChannelmanagerChannelResponseWithAssociations()
        if include_optional:
    ...
    def testChannelmanagerChannelResponseWithAssociations(self):
        """Test ChannelmanagerChannelResponseWithAssociations"""
